...
async function testSegmentedControl(SegmentedControl: ComponentType) {
  ...
  expect(firstOption).toHaveClass('bg-primary-30 text-gray-95')
  expect(secondOption).not.toHaveClass('bg-primary-30 text-gray-95')
  expect(thirdOption).not.toHaveClass('bg-primary-30 text-gray-95')
  ...
  expect(secondOption).toHaveClass('bg-primary-30 text-gray-95')
  expect(firstOption).not.toHaveClass('bg-primary-30 text-gray-95')
  expect(thirdOption).not.toHaveClass('bg-primary-30 text-gray-95')
  ...
  expect(thirdOption).toHaveClass('bg-primary-30 text-gray-95')
  expect(firstOption).not.toHaveClass('bg-primary-30 text-gray-95')
  expect(secondOption).not.toHaveClass('bg-primary-30 text-gray-95')
  expect(screen.queryByText('First content')).not.toBeInTheDocument()
  expect(screen.queryByText('Second content')).not.toBeInTheDocument()
